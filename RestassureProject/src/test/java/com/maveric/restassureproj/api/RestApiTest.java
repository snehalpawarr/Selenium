...
//*******************************   POST   ***********************************************
		...
		public void test8() {
			...
			//.body("sucessfull", CoreMatchers.equalToObject(""));
        }
		...
		@Test(testName ="Login successfull post method using json")
		...
		@Test(testName ="Register Unsuccessfull post method using json")
		public  void test11() throws Exception {
			
			ObjectMapper mapper=new ObjectMapper();
			FileInputStream stream=new FileInputStream("./TestData/RegisterUnsuccessfull.json");
			RegisterPojo  payload=mapper.readValue(stream, RegisterPojo.class);
		...
		@Test(testName ="Login Unsuccessfull post method using json")
		public  void test12() throws Exception {
			
			ObjectMapper mapper=new ObjectMapper();
			FileInputStream stream=new FileInputStream("./TestData/LoginUnsuccessfull.json");
			RegisterPojo  payload=mapper.readValue(stream, RegisterPojo.class);
